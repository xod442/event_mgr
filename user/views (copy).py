...
def register():
    man1 = 'russell.ware@hpe.com'
    man2 = 'hitendra.soni@hpe.com'
    man3 = 'rick.a.kauffman@hpe.com'
    form = RegisterForm()
    if form.validate_on_submit():
        ...
        man_html = render_template('mail/user/man.html', user=user)
        man_txt = render_template('mail/user/man.txt', user=user)
        email(user.email, "Thank You for regstering for the HPE DCN Work Shop", body_html, body_text)
        #email(man1, "New DCN Registration", man_html, man_txt)
        #email(man2, "New DCN Registration", man_html, man_txt)
        email(man3, "New DCN Registration", man_html, man_txt)
